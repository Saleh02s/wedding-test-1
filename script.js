...
const CONFIG = {
  ...
  weddingDateTime: "2026-09-12T17:00:00",

  /* Pretty display strings (edit freely, purely cosmetic) */
  displayDateLong:  "Saturday, the 12th of September, 2026",
  displayDateShort: "12.09.2026",
  displayMonthDay:  "September 12, 2026",
  displayTime:      "17:00",
...
curtainVideo.src = (useWebm ? "assets/curtain.webm" : "assets/curtain-alpha.mp4") + "#t=0.001";
...
function openCurtains() {
  ...
  if (p && p.catch) p.catch(finishCurtains); // if playback is blocked, reveal anyway
